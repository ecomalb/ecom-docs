...
| transactionType         | тип транзакції у цифровому значенні                      | string       | <p>76 - повернення по операції Purchase<br>213 - повернення по операції Preauth<br>214 - повернення по операції Complition</p> |
