...
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- | ------------------------------------ | ------------------ |
| merchantId       | id мерчанта в ecom                                                                                                                                                                                                                                                                |  uuid(36)        | 137d9304-0368-11ed-b939-0242ac120002 | так                |
| **filters**      | Список фільтрів.                                                                                                                                                                                                                                                                  | array            |                                      |                    |
| filters.operator | <p>Оператор для фільтрування.</p><p>IN – відповідає значенню в списку, дозволяє додавати кілька значень для фільтрування.</p><p>GTE – більше або дорівнює.</p><p>LTE – менше або дорівнює.</p><p>EQUALS – дорівнює.</p><p>LIKE – фільтр LIKE передається без параметра field.</p> | string           | `EQUALS`                             |                    |
...
| -------------------------- | ----------------------- | ---------------- | ------------------ | ----------------------- |
| id                         | Id платежу              | uuid             |                    |                         |
| orderId                    | Id підписки             | string           | ні                 |                         |
| planId                     | id плану                | string           | ні                 |                         |
