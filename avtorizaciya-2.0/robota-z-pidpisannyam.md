...
</strong><strong>    "jti" : "80c85dd4-2dd8-4229-993b-291838a3ad85", // Кожен відправлений JWS токен має мати 
</strong><strong>    //унікальний jti параметр, повторна відправка того самого JWS видасть помилку
...
* Ідентифіктор `jti` для кожного запиту, повинен бути унікальним

{% hint style="danger" %}
#### Умова помилки:

Кожен відправлений JWS токен має мати унікальний jti параметр, повторна відправка того самого jws видасть помилку
{% endhint %}
