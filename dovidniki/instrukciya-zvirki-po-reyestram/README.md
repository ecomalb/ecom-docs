...
* Виконайте пошук за ключовими параметрами (наприклад, operationId або rrn) для знаходження відповідних записів. Також для більш гнучкої звірки, можете використовувати параметрами з **`merchantComment`, `purpose`.**
...
### Робота з  **`merchantComment` , `purpose`**

До платіжного API був доданий новий параметр **`merchantComment`, `purpose`**,  який також буде у реєстрах.
...
Дані, передані у параметрі `merchantComment`, **`purpose`** будуть автоматично експортуватися у щоденні реєстри.
