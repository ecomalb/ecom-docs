...
1. Після успішного `PREAUTH` кошти блокуються на картці клієнта, але не списуються остаточно.
2. Замовлення переводиться у статус очікування, наприклад **Pending**.
3. Після підтвердження товару або готовності замовлення адміністратор запускає операцію **Completion** відповідно до можливостей плагіна.
4. Після успішного completion замовлення переводиться у статус успішно оплаченого, наприклад **Confirmed**.
5. Якщо completion не виконано до завершення строку дії авторизації, резерв коштів може бути скасований банком.
