---
description: Налаштування платіжного модуля перед початком роботи.
---
...
Натиснувши на редагувати ![](<../../.gitbook/assets/image (8) (1) (1).png>) , відкривається деталі поверення де можна переглянути інформацію про користувача, переглянути\вказати причину поверення, змінити статус та змінити товар&#x20;
