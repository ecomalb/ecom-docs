...
Натиснувши на редагувати ![](<../../.gitbook/assets/image (8).png>) , відкривається деталі поверення де можна переглянути інформацію про користувача, переглянути\вказати причину поверення, змінити статус та змінити товар&#x20;
